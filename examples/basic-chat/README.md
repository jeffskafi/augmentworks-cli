...
YAML before starting an assessment. This 0.3.7 package can preview the sanitized
...
published npm tarball. `npx @augmentworks/cli@0.3.7` cannot start this
...
`node dist/index.js init --starter response-only` in this 0.3.7 package.

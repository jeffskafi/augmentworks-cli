...
Use the pinned @augmentworks/cli@0.3.0 package. Run:
...
npx --yes @augmentworks/cli@0.3.0 doctor -c augmentworks.yaml
...
4. Run `npx --yes @augmentworks/cli@0.3.0 init --agent` to generate

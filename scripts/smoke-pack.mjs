...
function assertInventory(report) {
  ...
  for (const path of [
    ...
    "contracts/aw-real-data-1.schema.json",
    "contracts/aw-real-data-1.fixtures.json",
    "contracts/aw-real-data-1.checksums.json",
    "contracts/aw-real-data-1.retrieval.json",

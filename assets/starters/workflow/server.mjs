...
function toolEvents(turnId, order, success, output) {
...
const server = createServer(async (request, response) => {
  try {
    ...
    if (request.url === "/chat") {
      ...
      if (/\[aw-connection-probe\]/i.test(body.message)) {
        sendJson(response, 200, {
          answer: "probe-ack",
          finish_reason: "stop",
          events: [],
      ...
      if (/\[aw-tool-failure\]|simulate processor failure/i.test(body.message)) {
        sendJson(response, 200, {
          answer: "The synthetic refund processor failed. The order was not changed.",
          finish_reason: "stop",
          events: toolEvents(turnId, fixture.order, false, { status: "processor_failed" }),
          finished: true
        });
        return;
      }
      ...
      if (eligible) {
        ...
        sendJson(response, 200, {
          ...
          finish_reason: "stop",
          events: toolEvents(turnId, fixture.order, true, { status: "refunded" }),
          finished: true
        });
        return;
      }
